...
Learn how to build, configure, and extend Echo Build, the SpaceXAI-branded terminal coding agent for the OpenRouter ecosystem.
...
Customize and extend Echo Build.
...
Automate, script, and integrate Echo Build with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `echo-build -p`, output formats, CI/CD integration, and piping |
