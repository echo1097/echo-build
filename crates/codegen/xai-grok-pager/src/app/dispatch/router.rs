...
use super::auth::{
    dispatch_cancel_login, dispatch_login, dispatch_logout, dispatch_show_auth_management,
...
pub(crate) fn dispatch(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::ShowAuthManagement => dispatch_show_auth_management(app),
        ...
        Action::SubmitApiKey(api_key) => dispatch_submit_api_key(app, api_key),
        Action::CopyAuthUrl => {
